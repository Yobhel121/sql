...
where TABLE_NAME = 'fs_ly_pos_data';



show create table tb_special_trans;


select max(created_at) from tb_special_trans;


alter table rpa_data.pdd_operate_overview change created_at created_at timestamp not null default current_timestamp comment '创建时间';
alter table rpa_data.pdd_operate_overview change updated_at updated_at timestamp DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP comment '更新时间';




syyz_after_sales_data
yy_dialogue_records
pdd_operate_overview


show create table rpa_data.pdd_operate_overview;
