drop table tmp.fulfillment_07_02;
create table tmp.fulfillment_07_02 as
select
    flag_names  订单标记
...
left join(
    ...
    where !(c.goods_name like '%便携装%' and case when b.sell_total is not null then cast(b.sell_total as decimal(10,2)) - cast(b.share_favourable_fee as decimal(10,2))  else a.share_favourable_after_fee end > 0)
