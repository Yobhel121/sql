...
left join(
    select
        ...
        if(case when b.sell_total is not null then cast(b.sell_total as decimal(10,2)) - cast(b.share_favourable_fee as decimal(10,2))  else a.share_favourable_after_fee end >= 1,0,d.adjustment_cost) as item_cost, -- 商品成本
        if(case when b.sell_total is not null then cast(b.sell_total as decimal(10,2)) - cast(b.share_favourable_fee as decimal(10,2))  else a.share_favourable_after_fee end < 1,d.adjustment_cost,0) as gift_cost, -- 赠品费用
        -- 分摊后金额
