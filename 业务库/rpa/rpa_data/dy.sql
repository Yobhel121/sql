...
CREATE TABLE dy_account_daily_consumption
(
    id            bigint AUTO_INCREMENT COMMENT '主键ID，自增',
    account_id    BIGINT         NOT NULL COMMENT '账户ID',
    account_name  VARCHAR(255)   NOT NULL COMMENT '账户名称',
    consumption   DECIMAL(10, 2) NOT NULL COMMENT '消耗金额',
    biz_day       DATE           NOT NULL COMMENT '消耗日期',
    ...
    updated_at    timestamp      NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
    PRIMARY KEY (id)
) COMMENT ='抖音-巨量千川-首页-数据概览-乘方消耗';

select '抖音-巨量千川-首页-数据概览-乘方消耗',
       'dy_account_daily_consumption',
       COLUMN_NAME,
       DATA_TYPE,
       COLUMN_COMMENT,
       CHARACTER_MAXIMUM_LENGTH
from INFORMATION_SCHEMA.COLUMNS
where TABLE_NAME = 'dy_account_daily_consumption';
